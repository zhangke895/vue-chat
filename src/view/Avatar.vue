<template>
    <div class="wrapper">
        <Header></Header>
        <vue-cropper ref="cropper" :fixed="option.fixed" :img="option.img" :outputSize="option.size" :outputType="option.outputType" :info="option.info" :canMoveBox="option.canMoveBox" :autoCrop="option.autoCrop"></vue-cropper>
        <div class="tools">
